<template>
  <div class="home">
    ...
    <form class="w-full max-w-sm mx-auto bg-gray-800 shadow-md rounded px-8 pt-6 pb-8 mb-4">
      <div class="mb-4">
      ...
      <div class="flex items-center justify-between">
        ...
        >Sign In</button>
        <a
          class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-200"
          href="#"
          title="Soon!"
        >Forgot Password?</a>
      </div>
